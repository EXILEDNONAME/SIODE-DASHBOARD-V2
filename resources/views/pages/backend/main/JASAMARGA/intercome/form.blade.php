...
<div class="form-group row">
  ...
  <div class="col-lg-9">
    {!! Form::text('area', (isset($data->area) ? $data->area : ''), ['class' => $errors->has('area') ? 'form-control is-invalid' : 'form-control']) !!}
...
<div class="form-group row">
  ...
  <div class="col-lg-9">
    {!! Form::number('code', (isset($data->code) ? $data->code : ''), ['class' => $errors->has('code') ? 'form-control is-invalid' : 'form-control']) !!}
