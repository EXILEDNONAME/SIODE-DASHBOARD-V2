            ...
            <div class="d-flex align-items-center">
              ...
              <div class="d-flex align-items-center flex-wrap w-xxl-200px mr-3" data-toggle="view">
                <span class="symbol symbol-35 mr-3">
                  <span class="symbol-label" style="background-image: url('/assets/backend/media/users/100_13.jpg')" title="Sean Paul"></span>
                </span>
              </div>
            </div>
            <div class="flex-grow-1 mr-2" data-toggle="view">
              <div>
                <span class="font-weight-bolder font-size-lg mr-2">Sean Paul - </span>
                <span class="font-weight-bolder font-size-lg mr-2">Digital PPV Customer Confirmation </span><br>
                <span class="text-muted">
                  Thank you for ordering UFC 240 Holloway vs Edgar Alternate camera angles...
                </span>
              </div>
        ...
        <div class="mb-3">
          <div class="cursor-pointer shadow-xs toggle-on" data-inbox="message">
            <div class="d-flex align-items-center card-spacer-x py-6">
              ...
              @push('js')
              <script src="/assets/backend/js/pages/custom/inbox/inbox.js?v=7.0.5"></script>
              @endpush
