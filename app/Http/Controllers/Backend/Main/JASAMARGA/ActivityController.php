...
use App\Http\Requests\Backend\Main\JASAMARGA\Activity\StoreRequest;
use App\Http\Requests\Backend\Main\JASAMARGA\Activity\UpdateRequest;
...
class ActivityController extends Controller {
  ...
  **/
  ...
  public function __construct() {
    ...
    $this->url = '/dashboard/jasamarga/activities';
    $this->path = 'pages.backend.main.jasamarga.activity';
    $this->model = 'App\Models\Backend\Main\Jasamarga\Activity';
